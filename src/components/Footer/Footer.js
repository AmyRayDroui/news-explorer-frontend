      ...
      <footer className="footer page__wrapper">
          ...
          <div className="footer__container footer__container_type_general">
            <nav className="footer__container footer__container_type_links">
                <NavLink exact="true" to='/' className="footer__link">Home</NavLink>
            ...
            <div className="footer__container footer__container_type_media">
                <a className="footer__media" href="https://github.com/AmyRayDroui/news-explorer-frontend" >
                    <img className="footer__media-icon" src={githubIcon} alt="Github's logo"></img>
                </a>
                <a className="footer__media" href="https://www.facebook.com/Practicum100IL" >
                    <img className="footer__media-icon" src={facebookIcon} alt="Facebook's logo"></img>
                </a>
            </div>
          </div>
      </footer>
