          ...
          {currPath === "/saved-news" ? (
            <section className="news-list news-list_type_saved page__wrapper">
              <div className="news-list__container">
                {savedArticles.map((cardElement, index) => (
                  <NewsCard
                    key={index}
                    card={cardElement}
                  ...
                  <>
                    {!isErrorOccur ? (
                        ...
                        {isFoundCards ? (
                          <>
                            ...
                            <button
                              ...
                              className={`news-list__show-more ${!isShowMoreVisible &&
                          ...
                          <>
                            ...
                            <h2 className="news-list__title news-list__title_type_not-found">
                              Nothing found
                            </h2>
                      ...
                      <p className="news-list__not-found-text">
                        ...
                        <br />
                        There may be a connection issue or the server may be
                        down.
                        <br />
