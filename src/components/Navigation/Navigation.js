...
function Navigation() {
  ...
  return (
    <div className={ currPath==='/saved-news' ? "navigation page__wrapper navigation_type_black-font" : "navigation page__wrapper"}>
        ...
        <button className={`navigation_mobile-button ${ currPath === '/saved-news' && 'navigation_mobile-button_type_black'}`}></button>
        <Popup isOpen={isMobileNavOpen} name='navbar'>
          <nav className='.navigation__container navigation__container_type_popup'>
